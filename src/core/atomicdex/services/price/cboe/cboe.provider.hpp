...
namespace atomic_dex
{
    ...
    class cboe_provider final : public ag::ecs::pre_update_system<cboe_provider>
    {
        //! Typedefs
      ...
      public:
        //! Deleted operation
        cboe_provider(cboe_provider& other) = delete;
        cboe_provider(cboe_provider&& other) = delete;
        cboe_provider& operator=(cboe_provider& other) = delete;
        cboe_provider& operator=(cboe_provider&& other) = delete;

        //! Constructor
        cboe_provider(entt::registry& registry, ag::ecs::system_manager& system_manager) ;
...
REFL_AUTO(type(atomic_dex::cboe_provider))
