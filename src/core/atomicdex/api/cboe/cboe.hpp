...
namespace atomic_dex
{
    ...
    using t_price_converter_answer    = cboe::api::price_converter_answer;
    using t_price_converter_request   = cboe::api::price_converter_request;
    using t_ticker_info_answer        = cboe::api::ticker_info_answer;
    using t_ticker_infos_request      = cboe::api::ticker_infos_request;
    using t_ticker_historical_answer  = cboe::api::ticker_historical_answer;
    using t_ticker_historical_request = cboe::api::ticker_historical_request;
} // namespace atomic_dex
