...
Item
{
    ...
    Item
    {
        ...
        Rectangle
        {
            ...
            anchors.horizontalCenter: API.app.trading_pg.current_trading_mode == TradingMode.Pro ? _simpleLabel.horizontalCenter : _proLabel.horizontalCenter
...
/*
        DexLabel
        {
            id: _simpleLabel
            text: "Options"
            color: API.app.trading_pg.current_trading_mode == TradingMode.Options ? Dex.CurrentTheme.foregroundColor : Dex.CurrentTheme.foregroundColor2
            anchors.leftMargin: 16
            anchors.left: parent.left
            anchors.verticalCenter: parent.verticalCenter
            font.pixelSize: 14
            ...
            DexMouseArea
            {
                ...
                hoverEnabled: true
                anchors.fill: parent
                onClicked: API.app.trading_pg.current_trading_mode = TradingMode.Options
            }
        }
*/
