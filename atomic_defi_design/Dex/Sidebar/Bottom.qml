...
//    signal addCryptoClicked()
    signal addStocksClicked()
    signal addOptionsClicked()
    ...
    Connections
    {
        ...
        function onIsExpandedChanged()
        {
            ...
            {
                addStocksLine.label.opacity = 0;
                addOptionsLine.label.opacity = 0;
    ...
    NumberAnimation
    {
        ...
        targets: [addStocksLine.label, settingsLine.label, supportLine.label, privacyLine.label]
        properties: "opacity"
        duration: 200
        from: 0
        to: 0
    ...
    NumberAnimation
    {
        ...
        targets: [addOptionsLine.label, settingsLine.label, supportLine.label, privacyLine.label]
        properties: "opacity"
        duration: 350
        from: 0.0
        to: 1
    ...
    ColumnLayout
    {
        ...
        FigurativeLine
        {
            ...
            label.text: qsTr("Add Stock") // isExpanded ? qsTr("Add Crypto") : ""
            icon.source: General.image_path + "bank-plus.svg"
            onClicked: addStocksClicked()
        }
//        FigurativeLine
  //      {
    //        id: addOptionsLine
//
  //          Layout.fillWidth: true
    //        label.text: qsTr("Add Options") // isExpanded ? qsTr("Add Crypto") : ""
      //      icon.source: General.image_path + "bank-plus.svg"
        //    onClicked: addOptionsClicked()
//        }
