...
set(DEX_PROJECT_NAME "bitstock-wallet")
set(DEX_DISPLAY_NAME "BitStock")
set(DEX_MAINTENANCE_TOOL_NAME "BitStock Maintenance Tool")
...
set(DEX_PRIMARY_COIN "BITN")                                                  ## Main coin of the DEX, will be enabled by default and will be the default left ticker for trading
set(DEX_SECOND_PRIMARY_COIN "BITN")                                                  ## Second main coin of the DEX, will be enabled by default and will be the default right ticker for trading
set(DEX_REPOSITORY_OWNER ${DEX_COMPANY})
set(DEX_REPOSITORY_NAME "bitstock-wallet-desktop")
set(DEX_CHECKSUM_API_URL "https://komodo.earth/static/checksum.json")
if (APPLE)
    set(DEX_APPDATA_FOLDER "BitStock")
else ()
